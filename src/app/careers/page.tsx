  ...
  const jobs = [
    {
      ...
      type: 'Full-time',
      posted: '2 days ago',
      description: 'We are looking for an experienced frontend engineer to help build and improve our web application. You will work closely with designers and backend engineers to create beautiful, performant user interfaces.',
    },
    {
      id: 2,
      ...
      type: 'Full-time',
      posted: '1 week ago',
      description: 'Join our design team to create intuitive, engaging user experiences for our communication platform. Youll be involved in the entire product development process, from research to implementation.',
    },
    {
      id: 3,
      ...
      type: 'Full-time',
      posted: '3 days ago',
      description: 'Were seeking a backend engineer to help scale our infrastructure and build new features. Youll work with technologies like Node.js, PostgreSQL, and Redis to create robust, performant systems.',
    },
    {
      id: 4,
      ...
      type: 'Full-time',
      posted: '2 weeks ago',
      description: 'We are looking for a product manager to help define and execute our product strategy. You will work closely with engineering, design, and marketing teams to deliver features that delight our users.',
    },
    {
      id: 5,
      ...
      type: 'Full-time',
      posted: '5 days ago',
      description: 'Join our customer success team to help users get the most out of our platform. You will provide technical support, create documentation, and gather feedback to improve the product.',
    },
    {
      id: 6,
      ...
      type: 'Full-time',
      posted: '1 day ago',
      description: 'We are seeking a growth marketing manager to help expand our user base. You will develop and execute marketing strategies across various channels to drive user acquisition and retention.',
    },
  ];
