      ...
      <div className="flex-1 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="relative text-center animate-zoom-in">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8 text-lg max-w-lg mx-auto">
            Select from your existing chats or start a new conversation to begin messaging
          </p>
          ...
          <div className="mt-12 grid grid-cols-3 gap-6 max-w-md mx-auto">
            <div className="text-center">
              ...
              <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Instant</p>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-gray-600 dark:text-gray-400 font-medium">Social</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="relative group">
            ...
            {currentChat.type === 'direct' && currentChat.participants.length > 0 && (
              (() => {
                ...
                return (
                  <div className={`absolute -bottom-1 -right-1 w-4 h-4 rounded-full border-2 border-white dark:border-gray-900 shadow-sm ${
                    isOnline 
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1 font-medium">
              {currentChat.type === 'direct' && currentChat.participants.length > 0 ? (
                ...
                `${currentChat.participants.length} member${currentChat.participants.length !== 1 ? 's' : ''} • Group chat`
              )}
            </p>
          </div>
        </div>
              ...
              <div className="text-center animate-zoom-in">
                ...
                <div className="space-y-3 max-w-xs mx-auto">
                  <div className="flex items-center space-x-3 p-3 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-xl border border-white/20 dark:border-gray-700/30">
                    ...
                    <span className="text-sm text-gray-600 dark:text-gray-400">Say hello 👋</span>
                  </div>
                  <div className="flex items-center space-x-3 p-3 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-xl border border-white/20 dark:border-gray-700/30">
                    <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse animation-delay-2000"></div>
                    <span className="text-sm text-gray-600 dark:text-gray-400">Share a photo 📸</span>
                  </div>
                  <div className="flex items-center space-x-3 p-3 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-xl border border-white/20 dark:border-gray-700/30">
                    <div className="w-2 h-2 bg-purple-500 rounded-full animate-pulse animation-delay-4000"></div>
                    <span className="text-sm text-gray-600 dark:text-gray-400">Ask a question ❓</span>
                  </div>
                </div>
              </div>
            </div>
